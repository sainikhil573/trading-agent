...
**Gated out:** ADANIENT PUT (NO_TRADE), DRREDDY CALL (NO_TRADE), MARUTI PUT (NO_TRADE)

## Data Health

[HEALTHY]  VIX: FRESH  |  FII_DII: FAILED  |  PARTICIPANT_OI: FAILED  |  OPTION_CHAIN: FRESH  |  GLOBAL_CUES: FRESH  |  TECHNICALS: FRESH  |  NEWS: FRESH
